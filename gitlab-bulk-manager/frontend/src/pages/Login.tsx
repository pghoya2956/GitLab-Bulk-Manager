    ...
    if (token) {
      try {
        ...
        if (response.data.success) {
          ...
          const user = {
            ...response.data.user,
            role: response.data.user.is_admin ? UserRole.ADMIN : UserRole.DEVELOPER,
            permissions: response.data.user.is_admin 
              ? Object.values(Permission) 
              : [Permission.VIEW_GROUPS, Permission.VIEW_PROJECTS]
          };
